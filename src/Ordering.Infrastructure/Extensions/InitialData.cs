...
internal static class InitialData
{
    public static IEnumerable<Customer> Customers =>
        new List<Customer>
        {
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "mike", "mikehanz@gmail.com"),
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Mike", "Hanz", "mikehanz@gmail.com", "Cavendish No:4", "Canada", "Montreal", "H7G6T6");
